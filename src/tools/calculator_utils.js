...
class Calculator {
    ...
    evaluatePostfixStack(postfixStack) {
        ...
        const result = temporaryStack.pop();

        if (isWithinSafeNumRange(result)) {
            return result;
        } else {
            return "Please keep your calculations relatively simple! E.g. |answer| < 10^15"
        }
...
function isWithinSafeNumRange(num) {
